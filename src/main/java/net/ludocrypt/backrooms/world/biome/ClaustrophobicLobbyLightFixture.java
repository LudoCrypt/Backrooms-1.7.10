...
import net.ludocrypt.backrooms.world.biome.base.LobbyLightFixtureBaseBiome;
import net.minecraft.world.World;

public class ClaustrophobicLobbyLightFixture extends LobbyLightFixtureBaseBiome {

	public ClaustrophobicLobbyLightFixture(int i) {
		super(i);
		...
		this.downfall = 0.0F;
		this.setSeedModifier(6727605);
	}

	@Override
	public void generateRoom(World world, long seed, Random random, BlockPos pos) {
		BackroomsRooms.CLAUSTROPHOBIC_WALLED.generate(world, seed, random, pos);
	}

	@Override
	public void cleanupRoom(World world, long seed, Random random, BlockPos pos) {
		BackroomsRooms.CLAUSTROPHOBIC_WALLED.cleanup(world, seed, random, pos);
	}
