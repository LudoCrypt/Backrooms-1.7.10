...
public class PipesHallwaysZ extends PipesBaseBiome {

	public PipesHallwaysZ(int i) {
		super(i);
		...
		this.downfall = 0.0F;
		this.setSeedModifier(6727623);
	}

	@Override
	public void generateRoom(World world, long seed, Random random, BlockPos pos) {
		BackroomsRooms.PIPES_HALLWAYS_Z.generate(world, seed, random, pos);
	}

	@Override
	public void cleanupRoom(World world, long seed, Random random, BlockPos pos) {
		BackroomsRooms.PIPES_HALLWAYS_Z.cleanup(world, seed, random, pos);
	}
