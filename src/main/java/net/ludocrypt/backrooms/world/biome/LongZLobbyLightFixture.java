...
public class LongZLobbyLightFixture extends LobbyLightFixtureBaseBiome {

	public LongZLobbyLightFixture(int i) {
		super(i);
		...
		this.downfall = 0.0F;
		this.setSeedModifier(6727603);
	}

	@Override
	public void generateRoom(World world, long seed, Random random, BlockPos pos) {
		BackroomsRooms.WALLED_LONG_Z.generate(world, seed, random, pos);
	}

	@Override
	public void cleanupRoom(World world, long seed, Random random, BlockPos pos) {
		BackroomsRooms.WALLED_LONG_Z.cleanup(world, seed, random, pos);
	}
