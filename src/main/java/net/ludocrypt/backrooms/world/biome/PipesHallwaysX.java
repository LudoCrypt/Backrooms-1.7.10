...
public class PipesHallwaysX extends PipesBaseBiome {

	public PipesHallwaysX(int i) {
		super(i);
		...
		this.downfall = 0.0F;
		this.setSeedModifier(6727624);
	}

	@Override
	public void generateRoom(World world, long seed, Random random, BlockPos pos) {
		BackroomsRooms.PIPES_HALLWAYS_X.generate(world, seed, random, pos);
	}

	@Override
	public void cleanupRoom(World world, long seed, Random random, BlockPos pos) {
		BackroomsRooms.PIPES_HALLWAYS_X.cleanup(world, seed, random, pos);
	}
