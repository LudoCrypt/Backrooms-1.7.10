...
public class PipesBiome extends PipesBaseBiome {

	public PipesBiome(int i) {
		super(i);
	...
	public void generateRoom(World world, long seed, Random random, BlockPos pos) {
		BackroomsRooms.PIPES.generate(world, seed, random, pos);
	}

	@Override
	public void cleanupRoom(World world, long seed, Random random, BlockPos pos) {
		BackroomsRooms.PIPES.cleanup(world, seed, random, pos);
	}
