...
public class MaintenanceLongX extends MaintenanceBaseBiome {

	public MaintenanceLongX(int i) {
		super(i);
		...
		this.downfall = 0.0F;
		this.setSeedModifier(6727626);
	}

	@Override
	public void generateRoom(World world, long seed, Random random, BlockPos pos) {
		BackroomsRooms.DRYWALL_LONG_X.generate(world, seed, random, pos);
	}

	@Override
	public void cleanupRoom(World world, long seed, Random random, BlockPos pos) {
		BackroomsRooms.DRYWALL_LONG_X.cleanup(world, seed, random, pos);
	}
