...
public class PipesHallwaysZRoom extends PipedRoom {

	public PipesHallwaysZRoom(int id, String name, double xScale, double zScale, Block blockBottom, Block blockTop, Block blockTopTop, Block carpet, Block ceilingA, Block ceilingB) {
