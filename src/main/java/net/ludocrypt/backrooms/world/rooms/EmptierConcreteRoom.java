...
public class EmptierConcreteRoom extends WalledRoom {

	public EmptierConcreteRoom(int id, String name, double xScale, double zScale, Block block) {
		super(id, name, xScale, zScale, block);
	}

	public EmptierConcreteRoom(int id, String name, double xScale, double zScale, Block blockBottom, Block blockTop, Block blockTopTop, Block carpet) {
	...
	protected List<Pair<Boolean, OctavePerlinNoiseSampler>> setNoisemapEast(long seed) {
		return OctavePerlinNoiseSampler.createNoise(Lists.newArrayList(false, false, false, true, false, false, false), seed);
	}
	...
	protected List<Pair<Boolean, OctavePerlinNoiseSampler>> setNoisemapDoor(long seed) {
		return OctavePerlinNoiseSampler.createNoise(Lists.newArrayList(true, true, false, true, true, false, false, true), seed);
	}
